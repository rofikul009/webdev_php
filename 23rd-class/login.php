        ...
        <div class="form-row">
          ...
          <div class="col-12">
            <div class="input-group mb-3">
              ...
              <input name="email" type="email" value="" class="input form-control" id="username" placeholder="email" aria-label="Username" aria-describedby="basic-addon1" />
            </div>
          </div>
          <div class="col-12">
            <div class="input-group mb-3">
          ...
          <div class="col-12">
            <div class="input-group mb-3">
              <div class="input-group-prepend">
                <span class="input-group-text" id="basic-addon1"><i class="fas fa-date"></i></span>
              </div>
              <input name="date" type="date" value="" class="input form-control" id="">
            </div>
          </div>
          <div class="col-6">
